...
public class ImplementationRuleRegister extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cadastro de Regra de Implementação");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	try{
    		...
    		this.limpar();
    		JOptionPane.showMessageDialog(null, "Regra de Implementação inserida com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
