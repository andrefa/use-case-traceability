 ...
 * @author Marcos
 */
public class UseCaseCrud extends javax.swing.JPanel {
	private UseCase ucSelected;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Caso de Uso");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	UseCase uc = (UseCase)this.jComboBox1.getSelectedItem();
    	this.ucSelected = uc;
        this.jTextField1.setText(uc.getId());
        this.jTextField2.setText(uc.getName());
        this.jTextArea1.setText(uc.getDescription());
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
    	try{
    		...
    		this.ucSelected.setName(this.jTextField2.getText());
    		this.ucSelected.setDescription(this.jTextArea1.getText());
    		
    		buc.update(CurrentProject.getCurrentProject(), this.ucSelected);
    		
    		this.setDadosCombo(buc.getAllUseCase());
    		...
    		JOptionPane.showMessageDialog(null, "Caso de Uso atualizado com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
    	try{
    		...
    		buc.remove(CurrentProject.getCurrentProject(), this.ucSelected);
    		...
    		JOptionPane.showMessageDialog(null, "Caso de Uso excluído com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
    	}catch (CoreException e) {
			JOptionPane.showMessageDialog(null, e.getMessage(), "Erro!", JOptionPane.ERROR_MESSAGE);
		}catch (Exception e) {
			JOptionPane.showMessageDialog(null, e.getMessage(), "Erro!", JOptionPane.ERROR_MESSAGE);
    ...
    public void setDadosCombo(List<UseCase> useCases){
    	this.jComboBox1.removeAllItems();
    	for(UseCase uc : useCases){
    		this.jComboBox1.addItem(uc);
    	}
    }
