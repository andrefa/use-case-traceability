...
public class BusinessHtmlReport extends AbstractBussiness {
	...
	public void generateHtmlReport(Project project) throws Exception{
		...
		html.append("<html>");
		html.append("<title>Relat�rio de Rastreabilidade</title>");
		...
		html.append("</TD>");
		html.append("<TD align='center'>");
		html.append("Descri��o");
		html.append("</TD>");
		html.append("<TD align='center'>");
		html.append("M�todos Implementados");
		html.append("</TD>");
		html.append("</TR>");
		...
		html.append("<TR bgcolor='#E6E6FA'>");
		html.append("<TD align='center' colspan='4'>");
		html.append("Regras de Implementa��o");
		html.append("</TD>");
		html.append("</TR>");
		html.append("<TR bgcolor='#E6E6FA'>");
		html.append("<TD align='center'>");
