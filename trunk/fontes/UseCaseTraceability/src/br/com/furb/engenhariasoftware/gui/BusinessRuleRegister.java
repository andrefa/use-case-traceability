 ...
 * @author Marcos
 */
public class BusinessRuleRegister extends javax.swing.JPanel {

    /** Creates new form FunctionalRequisiteRegister */
    public BusinessRuleRegister() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cadastro de Regra de Negócio");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	try{
    		...
    		bbr.insertBusinessRule(CurrentProject.getCurrentProject(), this.jTextField1.getText(), 
    				this.jTextField2.getText(), this.jTextArea1.getText());
    		
    		
    		this.limpar();
    		JOptionPane.showMessageDialog(null, "Regra de Negócio inserida com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
