 ...
 * @author Marcos
 */
public class FunctionalRequisiteRegister extends javax.swing.JPanel {

    /** Creates new form FunctionalRequisiteRegister */
    public FunctionalRequisiteRegister() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Cadastro de Requisito Funcional");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
    	try{
    		...
    		bfr.insertFunctionalRequisite(CurrentProject.getCurrentProject(), this.jTextField1.getText(), 
    				this.jTextField2.getText(), this.jTextArea1.getText());
    		
    		
    		this.limpar();
    		JOptionPane.showMessageDialog(null, "Requisito Funcional inserido com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
