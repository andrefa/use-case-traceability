 ...
 * @author Marcos
 */
public class ImplementationRuleCrud extends javax.swing.JPanel {
	private ImplementationRule irSelected;
	private boolean canUpdate;
	private boolean canDelete;
	
    /** Creates new form FunctionalRequisiteCrud */
    public ImplementationRuleCrud() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar Regra de Implementação");

        jLabel2.setText("Regra de Implementação: ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
    	ImplementationRule ir = (ImplementationRule)this.jComboBox1.getSelectedItem();
    	this.irSelected = ir;
        this.jTextField1.setText(ir.getId());
        this.jTextField2.setText(ir.getName());
        this.jTextArea1.setText(ir.getDescription());
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
    	try{
    		...
    		this.irSelected.setName(this.jTextField2.getText());
    		this.irSelected.setDescription(this.jTextArea1.getText());
    		
    		bir.update(CurrentProject.getCurrentProject(), this.irSelected);
    		
    		this.setDadosCombo(bir.getAllImplementationRule());
    		...
    		JOptionPane.showMessageDialog(null, "Regra de Implementação atualizada com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
    	try{
    		...
    		bir.remove(CurrentProject.getCurrentProject(), this.irSelected);
    		...
    		JOptionPane.showMessageDialog(null, "Regra de Implementação excluída com sucesso!", "Info!", JOptionPane.INFORMATION_MESSAGE);
    	}catch (CoreException e) {
			JOptionPane.showMessageDialog(null, e.getMessage(), "Erro!", JOptionPane.ERROR_MESSAGE);
		}catch (Exception e) {
			JOptionPane.showMessageDialog(null, e.getMessage(), "Erro!", JOptionPane.ERROR_MESSAGE);
    ...
    public void setDadosCombo(List<ImplementationRule> implementationRules){
    	this.jComboBox1.removeAllItems();
    	for(ImplementationRule ir : implementationRules){
    		this.jComboBox1.addItem(ir);
    	}
    }
